...
public class PeminjamanDemo {
    public static void main(String[] args) {
        ...
        Peminjaman[] arrPeminjaman = {
            new Peminjaman(arrMhs[0], arrBuku[0], 7),
            new Peminjaman(arrMhs[1], arrBuku[1], 3),
            new Peminjaman(arrMhs[2], arrBuku[2], 10),
            new Peminjaman(arrMhs[2], arrBuku[3], 6),
            new Peminjaman(arrMhs[0], arrBuku[1], 4)
        };
        ...
        do {
            ...
            switch (pilihan) {
                ...
                case 3:
                    System.out.println("\nData Peminjaman:");
                    for (Peminjaman p : arrPeminjaman) {
                        p.tampilPeminjaman();
                    }
                    break;

                case 4:
                    operasi.bubbleSortDenda(arrPeminjaman); // Memanggil method dari class OperasiPeminjaman
